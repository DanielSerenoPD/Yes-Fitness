...
export const CheckOutScreen = ({navigation}: Props) => {
  ...
  const actualizarSuscripcion = async(data:any)=>{
    ...
    .update({
      ...
      suscripcionActual:{
        ...
        plan:{name:"10 Clases", price:data.plan.value},
        status: true,
      }, 
    });
  }
  ...
  <WebView
        source ={{uri:'https://client-stripe-integration.herokuapp.com/basic'}}
        //Reemplazar con la direccion del servido  donde esta la api
        ref = {(ref)=>webView=ref}
