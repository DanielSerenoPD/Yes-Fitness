...
export const ApartarClaseGenericoScreen = ({navigation, route}: Props) => {
  const {
    datosEstudio,
    datosClase,
    datosCoach,
  ...
  const formatearFechaHoy = () => {
    let fecha = diaSeleccionadoGenerico.fechaFormato;
  ...
  const apartarClase = async () => {
    ...
    let añoClase = diaSeleccionadoGenerico.fechaFormato.getFullYear();
    let mesClase = diaSeleccionadoGenerico.fechaFormato.getMonth();

    //Obtenemos el numero de mes y año
    let año = diaSeleccionadoGenerico.fechaFormato.getFullYear();
    //sacamos la fecha completa: ej: 13/20/2021
    let fechaReserva =
      diaSeleccionadoGenerico.fechaFormato.toLocaleDateString('es');
    ...
    try {
      ...
      if (datosReserva.idDocumento) {
        ...
        //primero transformamos los datos de la fecha
        ...
        let año = diaSeleccionadoGenerico.fechaFormato.getFullYear();
        let mes = diaSeleccionadoGenerico.fechaFormato.getMonth();
        let dia = diaSeleccionadoGenerico.fechaFormato.getDate();
